---
name: notebooklm-local-analyzer
description: Use when analyzing local documents with Google NotebookLM. Upload business documents, financial reports, or proposals to get AI-powered insights, risk assessments, and actionable recommendations.
---
