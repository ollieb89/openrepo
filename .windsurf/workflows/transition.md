...
```bash
TRANSITION=$(node /home/ollie/.claude/get-shit-done/bin/gsd-tools.cjs phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node /home/ollie/.claude/get-shit-done/bin/gsd-tools.cjs progress bar --raw)
```
...
```bash
node /home/ollie/.claude/get-shit-done/bin/gsd-tools.cjs config-set workflow.auto_advance false
```
