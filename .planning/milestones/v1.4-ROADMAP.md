...
- [x] **Phase 44: v1.4 Tech Debt Cleanup** - Document OPENCLAW_ROOT export requirement, fix SummaryStream.tsx parse error, and audit stale test patch targets (completed 2026-02-25)
