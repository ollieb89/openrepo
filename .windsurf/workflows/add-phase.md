...
```bash
INIT=$(node /home/ollie/.claude/get-shit-done/bin/gsd-tools.cjs init phase-op "0")
```
...
```bash
RESULT=$(node /home/ollie/.claude/get-shit-done/bin/gsd-tools.cjs phase add "${description}")
```
