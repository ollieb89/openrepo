---
name: personas
description: Use when creating, managing, or deploying AI subagent personas with distinct personalities. Activate when a user requests to talk to a specific persona, delegate a conversation to a character, or create/list/edit personality profiles.
---
